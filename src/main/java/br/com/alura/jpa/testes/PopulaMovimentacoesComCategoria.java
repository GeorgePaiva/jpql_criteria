...
public class PopulaMovimentacoesComCategoria {
    ...
    public static void main(String[] args) {
        ...
        movimentacao3.setData(LocalDateTime.now().plusDays(1)); // amanhã
        movimentacao3.setDescricao("Mc Donalds");
        movimentacao3.setTipoMovimentacao(TipoMovimentacao.SAIDA);
        movimentacao3.setValor(new BigDecimal(84));
        movimentacao3.setCategorias(Arrays.asList(categoria3));
